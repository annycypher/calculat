...
export const SEARCH = [
  ...
  { t: '2048', u: '/games/2048.html', k: '2048 игра головоломка соединить числа плитки неон', d: 'Соединяйте плитки и соберите 2048 — с частицами и рекордами.' },
  { t: 'Пузыри', u: '/games/bubble.html', k: 'пузыри bubble shooter шарики лопать три в ряд аркада', d: 'Пузырьковый шутер: лопайте шары тройками и проходите уровни.' }
];
